...
# input_image = get_image(image_test5)
# out, out_s = Recognition(input_image, input_filter)
# print("Predicted Image:",(np.argmax(out_s)+1))
# print(out_s)

# input_image = get_image(image_test6)
# out, out_s = Recognition(input_image, input_filter)
# print("Predicted Image:",(np.argmax(out_s)+1))
# print(out_s)

# input_image = get_image(image_test7)
# out, out_s = Recognition(input_image, input_filter)
# print("Predicted Image:",(np.argmax(out_s)+1))
# print(out_s)

# input_image = get_image(image_test8)
# out, out_s = Recognition(input_image, input_filter)
# print("Predicted Image:",(np.argmax(out_s)+1))
# print(out_s)

# input_image = get_image(image_test9)
# out, out_s = Recognition(input_image, input_filter)
# print("Predicted Image:",(np.argmax(out_s)+1))
# print(out_s)

# input_image = get_image(image_test10)
# out, out_s = Recognition(input_image, input_filter)
# print("Predicted Image:",(np.argmax(out_s)+1))
# print(out_s)