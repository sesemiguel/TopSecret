...
def Training(input_img, input_filter, convolved_nodes_to_output_nodes, target_value):
	...
	return input_filter, convolved_nodes_to_output_nodes, output_nodes_flat_column, softmax_output, target_value
...
for jakol in range(0,iteration):
	print("Epoch: " , jakol+1)
	for x in range(0, mnist_depth):
		print(x)
		input_image = mnist_array[x]
		input_filter, convolved_nodes_to_output_nodes, out, out_s, tar = Training(input_image, input_filter, convolved_nodes_to_output_nodes, target_array[x])
		print(tar)
		print(out_s)
